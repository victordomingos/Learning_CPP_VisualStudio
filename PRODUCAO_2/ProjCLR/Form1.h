...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
            ...
            this->groupBox3->Text = L"Copiar por critério";
            // 
            // radio_todos
            // 
            ...
            this->genero_copia->HeaderText = L"Género";
...
private: void CopiarDados()
{
    ...
    if (localidade == "")
    {
        MessageBox::Show("Não foi indicada uma localidade.");
        txt_freg_cp->Focus();
        return;
    }
    ...
    for (int i = 0; i < n_formandos; i++)
    {
        genero_grid = dataGridView1->Rows[i]->Cells["Género"]->Value->ToString();
